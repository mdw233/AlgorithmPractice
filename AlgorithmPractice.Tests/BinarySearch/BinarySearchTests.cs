...
namespace AlgorithmPractice.Tests.BinarySearch
{
    [TestClass]
    public class BinarySearchTests
    {
        ...
        {
            var result = AlgorithmPractice.BinarySearch.BinarySearch.Run(_array, 11);
        ...
        public void BinarySearch_should_return_correct_value_when_matching_the_first_element()
        {
            ...
            var result = AlgorithmPractice.BinarySearch.BinarySearch.Run(_array, 1);
        ...
        {
            var array = new[] { 1, 3, 5, 7, 9 };
            var result = AlgorithmPractice.BinarySearch.BinarySearch.Run(_array, 9);
